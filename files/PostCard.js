          ...
          return (
            <button
              ...
              style={{
                ...
                padding: 0, textAlign: 'left', cursor: voted ? 'default' : 'pointer',
...
function ReactionBar({ reactions, onReaction }) {
  const REACTIONS = [
        ...
        return (
          <button
            ...
            style={{
              ...
              cursor: clicked ? 'default' : 'pointer', transition: 'all 0.15s'
            }}
          >
...
function CommentSection({ comments, onComment, postId }) {
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 10 }}>
        ...
        <button
          ...
          style={{
            ...
            border: '1px solid var(--border)', background: showForm ? '#EEF0FF' : 'transparent',
            color: showForm ? '#6C63FF' : 'var(--text-secondary)', cursor: 'pointer'
          }}
        >
...
export default function PostCard({ post, onVote, onReaction, onComment, showFull }) {
