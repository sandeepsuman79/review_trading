  ...
  return (
    <div style={{ minHeight: '100vh', background: 'var(--bg)' }}>
      ...
      <div className="container">
        <div className="card" style={{ position: 'relative', marginTop: 80, padding: '0 0 24px', marginBottom: 24, overflow: 'visible' }}>
          <div style={{ position: 'absolute', top: -55, left: 28, width: 110, height: 110, borderRadius: '50%', background: 'linear-gradient(135deg, #6C63FF, #FF6584)', border: '4px solid #fff', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 36, fontWeight: 700, color: '#fff', boxShadow: '0 8px 24px rgba(108,99,255,0.25)' }}>
            {p.name.split(' ').map((n) => n[0]).join('').slice(0, 2)}
          </div>
          <div style={{ padding: '0 28px', paddingTop: 70 }}>
